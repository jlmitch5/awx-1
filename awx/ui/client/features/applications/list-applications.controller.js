...
function ListApplicationsController (
    ...
    $scope.collection = { iterator, basePath: 'applications' };
    ...
    function handleSuccessfulDelete (app) {
        ...
        if (parseInt($state.params.job_template_id, 0) === app.id) {
